...
export default function ParsedQuizPage() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-slate-500 mt-4">Laddar quiz...</p>
      </div>
    )
  }
  ...
  if (!module || module.quiz.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <Link href="/utbildning/parsed" className="text-curago-600 hover:underline">
